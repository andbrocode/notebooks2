...
if __name__ == "__main__":
    ...
    path_to_magnitudes = "./BSPF_event_catalog_magnitudes.npy"
    
    path_to_catalog = "./BSPF_event_catalog_all.xml"
    
    # example for one-off b value estimation
    plt.style.use('bmh')
    plt.figure()

    magnitudes = np.load(path_to_magnitudes)
    ...
    cat = read_events(path_to_catalog, "QUAKEML")
