...
static void convs(int,int,double*,int,int,double*,int,int,double*);
...
static void convs (int lx, int ifx, double *x,
	   int ly, int ify, double *y, 
	   int lz, int ifz, double *z)
{
	int ilx=ifx+lx-1,ily=ify+ly-1,ilz=ifz+lz-1,
...
#ifdef TEST
static void conv1 (int lx, int ifx, float *x,
...
main()
{
	...
	while(1) {
		...
		/* convolve and check */
		conv1(lx,ifx,x,ly,ify,y,lz,ifz,z1);
