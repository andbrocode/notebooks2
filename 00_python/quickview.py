...
This quickview allows to plot a single data trace for a given time period. 
...
def __user_interaction(args):
    ...
    station = input("\nEnter station code (e.g. ROMY | RLAS | FUR ) default -> ROMY:  ") or 'ROMY'
    
    channel = input("\nEnter channel code (e.g. BJZ | HHZ) default -> BJZ:  ") or 'BJZ'
...
def __requesting_data(user_params):
    ...
    try:
        st, inv = __querrySeismoData(    
                                    ...
                                    repository=user_params.get("repos"),
