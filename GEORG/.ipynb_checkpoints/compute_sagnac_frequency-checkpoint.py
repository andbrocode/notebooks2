...
# specify seed codes [ sagnac signal, monobeam1, monobeam2 ]
config['seeds'] = [f"XX.GEORG..FJ{config['ring']}", "XX.GEORG..FJZ", "XX.GEORG..FJZ"]
...
config['path_to_autodata'] = "/import/kilauea-data/sagnac_frequency/bonn/data/"

# specify path to Sagnac data
config['path_to_data'] = "/import/kilauea-data/sagnac_frequency/bonn/"
...
config['path_to_sds'] = "/import/kilauea-data/sagnac_frequency/bonn/"
