...
config['seed'] = f"XX.GEORG..FJZ"

config['tbeg'] = "2024-10-01"
config['tend'] = "2024-10-02"

config['path_to_archive'] = f"/import/kilauea-data/sagnac_frequency/bonn/"

config['outpath_data'] = f"/import/kilauea-data/sagnac_frequency/bonn/"
...
def main(iii, date):
        ...
        for hh in tqdm(range(24)):
            ...
            try:
                ...
                #                print(" -> loading data ...")
                st = __read_sds(config['path_to_archive'], config['seed'], t1, t2)
