...
if "FFBI" in config['seed1']:
    ...
    config['path_to_inv1'] = root_path+"Documents/ROMY/ROMY_infrasound/dataless/station_BW_FFBI.xml"
elif "WETR" in config['seed1']:
    config['path_to_data1'] = data_path+f"LNM2/data/wettzell/"
    config['path_to_inv1'] = root_path+"Documents/ROMY/ROMY_infrasound/dataless/station_BW_WETR.xml"
...
elif "RLAS" in config['seed2']:
    config['path_to_data2'] = archive_path+f"romy_archive/"
    config['path_to_inv2'] = root_path+"Documents/ROMY/stationxml_ringlaser/dataless/dataless.seed.BW_RLAS"
...
def main(config):
    ...
    for date in date_range(str(config['date1'].date), str(config['date2'].date), days):
        ...
        ## conversion
        if "O" in st1[0].stats.channel and st1[0].stats.station == "FFBI":
