...
config['outpath'] = "/import/kilauea-data/LNM2/PSDS/FURT/"
...
def __get_data(config):
    ...
    try:
        st0 = read(config['path_to_data']+f"{config['type']}_{config['component']}_{date}.mseed")
