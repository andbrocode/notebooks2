...
config['opath'] = data_path+"LNM2/PSDS/ROMY/"
...
def main(config):
    ...
    for date in date_range(str(config['date1'].date), str(config['date2'].date), days):
        ...
        ## load data to stream
        st, inventory = __querrySeismoData(
