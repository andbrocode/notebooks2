...
config['d1'], config['d2'] = "2024-02-01", "2024-09-20"

config['path_to_data'] = data_path+f"LNM2/PSDS2/"
...
#     plt.setp(ax2_2.get_xticklabels(), visible=False)
    ...
    # ax4_2.set_xlabel("PSD (rad$^2$/s$^2$/Hz)", fontsize=font, labelpad=1)
...
def main(config):
    ...
    names = ["ROMY_BJZ", "ROMY_BJN", "ROMY_BJE", "FFBI_BDF"]
